...
Status: `R15A_PLUS_TV6_LAYER_OWNER_BOARD_UPDATED`
...
| 5 | Stage 10 Knowledge retrieval / TurboVec | TV-6 proved Android compile feasibility but not on-device runtime behavior. Lexical remains active; TurboVec stays PC/dev-only until load/query, memory, latency, and storage behavior are proven. |
