...
- Stable id: `scientific_reporting_validation_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/scientific_reporting_validation_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Ensure reports separate measured, calculated, inferred, user-confirmed, and diagnostic-only values.
...
- uncertainty labels
- audit trail
- diagnostic vs release distinction
...
```markdown
## Agent Handoff: Scientific Reporting & Validation Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
