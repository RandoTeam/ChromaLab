...
- Stable id: `qa_regression_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/qa_regression_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Own tests, fixtures, real-device validation, golden artifacts, and regression matrix.
...
```markdown
## Agent Handoff: QA / Regression Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
