...
- Stable id: `accessibility_localization_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/accessibility_localization_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Ensure UI is usable with accessibility, Russian/English labels, font scaling, contrast, touch targets.
...
```markdown
## Agent Handoff: Accessibility & Localization Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
