...
- Stable id: `security_privacy_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/security_privacy_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Review local image handling, storage, export, logs, model artifacts, and user privacy.
...
```markdown
## Agent Handoff: Security & Privacy Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
