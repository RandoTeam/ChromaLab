...
- Stable id: `android_performance_ondevice_ai_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/android_performance_ondevice_ai_agent.md`
...
```markdown
## Agent Handoff: Android Performance & On-Device AI Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
