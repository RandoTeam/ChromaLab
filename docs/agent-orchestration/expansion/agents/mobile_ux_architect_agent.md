...
- Stable id: `mobile_ux_architect_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/mobile_ux_architect_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Design the mobile workflow, user tasks, friction reduction, guided production flow, and error recovery.
...
- guided production task flow
- manual advanced fallback
- low-friction confirmations
- real-device usability script
...
```markdown
## Agent Handoff: Mobile UX Architect Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
