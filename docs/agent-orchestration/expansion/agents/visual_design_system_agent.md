...
- Stable id: `visual_design_system_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/visual_design_system_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Create non-generic, professional visual system for ChromaLab: colors, typography, spacing, components, overlays.
...
- overlay visual grammar
- non-generic mobile polish
...
```markdown
## Agent Handoff: Visual Design System Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
