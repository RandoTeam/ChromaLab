...
- Stable id: `chromatography_sme_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/chromatography_sme_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Review chromatographic terminology, peak metrics, report semantics, Kovats/retention index logic, and scientific caveats.
...
- baseline/noise caveats
- Kovats/RI conditions
- domain terminology
...
```markdown
## Agent Handoff: Chromatography SME Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
