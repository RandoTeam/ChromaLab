...
- Stable id: `compose_kmp_ui_agent`
- Authoritative file: `docs/agent-orchestration/expansion/agents/compose_kmp_ui_agent.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Implement Compose Multiplatform and Android UI screens from UX/design specifications.
...
- Compose state contracts
- zoom/pan canvas patterns
- state restoration
- performance-safe bitmaps
...
```markdown
## Agent Handoff: Compose/KMP UI Implementation Agent
- Scope:
- Files inspected:
- Research notes:
- Decisions:
