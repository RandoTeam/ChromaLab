...
Stop treating current full-auto as production path. This phase must move ChromaLab toward honest, evidence-gated mobile chromatogram digitization without pretending fully automatic photo analysis is production-ready by default.
