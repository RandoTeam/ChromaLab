...
Final report only after gates pass; otherwise diagnostic/review.

## Research requirement

Your model knowledge may be outdated. Before coding, search current official docs, maintained examples, and relevant methods for this phase. Save notes to `docs/research/YYYY-MM-DD_phase_07.md`.
