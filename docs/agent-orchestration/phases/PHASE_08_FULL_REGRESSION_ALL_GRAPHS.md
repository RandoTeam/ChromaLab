# Full Regression Across All Graphs

## Goal

Run all known graph types through all modes and close gaps.

## Research requirement

Your model knowledge may be outdated. Before coding, search current official docs, maintained examples, and relevant methods for this phase. Save notes to `docs/research/YYYY-MM-DD_phase_08.md`.
