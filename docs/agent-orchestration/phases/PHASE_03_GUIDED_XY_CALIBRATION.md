# Guided X/Y Calibration

## Goal

User places calibration anchors and validates residuals.

## Research requirement

Your model knowledge may be outdated. Before coding, search current official docs, maintained examples, and relevant methods for this phase. Save notes to `docs/research/YYYY-MM-DD_phase_03.md`.
