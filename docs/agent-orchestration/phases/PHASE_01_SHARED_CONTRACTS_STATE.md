# Shared Contracts + GuidedDigitizationState

## Goal

Create stable guided workflow contracts and persistent state machine.

## Research requirement

Your model knowledge may be outdated. Before coding, search current official docs, maintained examples, and relevant methods for this phase. Save notes to `docs/research/YYYY-MM-DD_phase_01.md`.
