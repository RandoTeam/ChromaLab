...
Use VLM as OCR/semantic/judge assistant only. This phase must move ChromaLab toward honest, evidence-gated mobile chromatogram digitization without pretending fully automatic photo analysis is production-ready by default.
