...
Your model knowledge may be outdated. Before using this skill, search current sources for: skeletonization/curve extraction methods. Save notes to `docs/research/YYYY-MM-DD_skill_07_trace_extraction_masks.md`.
