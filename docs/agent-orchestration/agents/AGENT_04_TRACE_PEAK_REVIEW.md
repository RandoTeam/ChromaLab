...
- Stable id: `AGENT_04_TRACE_PEAK_REVIEW`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_04_TRACE_PEAK_REVIEW.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Trace Extraction / Peak Review work for ChromaLab.
...
- trace mask evidence
- fragmented trace review
- peak apex alignment
- peak edit provenance
...
- SKILL_07_TRACE_EXTRACTION_MASKS
- SKILL_08_PEAK_REVIEW_INTEGRATION
...
```markdown
## Agent Handoff: Trace Extraction / Peak Review
- Scope:
- Files inspected:
- Research notes:
- Decisions:
