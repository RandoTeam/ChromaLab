...
- Stable id: `AGENT_02_GEOMETRY_CALIBRATION`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_02_GEOMETRY_CALIBRATION.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Geometry / Calibration Core work for ChromaLab.
...
- axis/tick localization
- robust calibration status
...
- SKILL_04_GEOMETRY_CALIBRATION_ROBUST_FIT
...
```markdown
## Agent Handoff: Geometry / Calibration Core
- Scope:
- Files inspected:
- Research notes:
- Decisions:
