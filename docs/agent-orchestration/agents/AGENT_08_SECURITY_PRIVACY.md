...
- Stable id: `AGENT_08_SECURITY_PRIVACY`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_08_SECURITY_PRIVACY.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Security / Privacy / Data Handling work for ChromaLab.
...
```markdown
## Agent Handoff: Security / Privacy / Data Handling
- Scope:
- Files inspected:
- Research notes:
- Decisions:
