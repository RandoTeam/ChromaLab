# Guided Workflow / UI / State Machine

## Agent Identity

- Stable id: `AGENT_01_GUIDED_WORKFLOW_UI`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_01_GUIDED_WORKFLOW_UI.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Guided Workflow / UI / State Machine work for ChromaLab.
...
- guided state taxonomy
- user confirmation checkpoints
- state restoration
- review and diagnostic labels
...
- SKILL_01_KMP_COMPOSE_ARCHITECTURE
- SKILL_02_STATE_MACHINE_PERSISTENCE
- SKILL_03_IMAGE_VIEWER_ROI_EDITOR
- SKILL_10_ANDROID_RUNTIME_EXPORT_LOGGING
...
```markdown
## Agent Handoff: Guided Workflow / UI / State Machine
- Scope:
- Files inspected:
- Research notes:
- Decisions:
