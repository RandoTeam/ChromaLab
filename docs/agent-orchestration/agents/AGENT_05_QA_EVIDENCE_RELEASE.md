# QA / Evidence / Benchmark / Release Gate

## Agent Identity

- Stable id: `AGENT_05_QA_EVIDENCE_RELEASE`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_05_QA_EVIDENCE_RELEASE.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns QA / Evidence / Benchmark / Release Gate work for ChromaLab.
...
```markdown
## Agent Handoff: QA / Evidence / Benchmark / Release Gate
- Scope:
- Files inspected:
- Research notes:
- Decisions:
