...
- Stable id: `AGENT_07_SCIENTIFIC_REPORT_PROVENANCE`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_07_SCIENTIFIC_REPORT_PROVENANCE.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Scientific Report / Provenance work for ChromaLab.
...
- measured/calculated/inferred separation
- review-grade labels
- diagnostic report language
- release-ready report contract
...
```markdown
## Agent Handoff: Scientific Report / Provenance
- Scope:
- Files inspected:
- Research notes:
- Decisions:
