...
- Stable id: `AGENT_03_OCR_VLM_TEXT`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_03_OCR_VLM_TEXT.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns OCR / VLM / Text Semantics work for ChromaLab.
...
- local crop OCR
- text classification
- title/ion rejection from peak evidence
- VLM timeout warnings
...
- SKILL_05_OCR_LOCAL_CROPS
- SKILL_06_VLM_SAFE_ASSISTANT
...
```markdown
## Agent Handoff: OCR / VLM / Text Semantics
- Scope:
- Files inspected:
- Research notes:
- Decisions:
