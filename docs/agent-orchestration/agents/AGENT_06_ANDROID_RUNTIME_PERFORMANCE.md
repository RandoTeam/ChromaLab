# Android Runtime / Performance / Storage

## Agent Identity

- Stable id: `AGENT_06_ANDROID_RUNTIME_PERFORMANCE`
- Authoritative file: `docs/agent-orchestration/agents/AGENT_06_ANDROID_RUNTIME_PERFORMANCE.md`
- Owner group: ChromaLab orchestration
- Product mode impact: `AUTO_DIAGNOSTIC`, `GUIDED_PRODUCTION`, `MANUAL_ADVANCED`

## Mission

Owns Android Runtime / Performance / Storage work for ChromaLab.
...
- SKILL_13_PERFORMANCE_TIMEOUTS
- SKILL_14_SECURITY_PRIVACY_STORAGE
...
```markdown
## Agent Handoff: Android Runtime / Performance / Storage
- Scope:
- Files inspected:
- Research notes:
- Decisions:
