...
Status: `R15A_BLOCKED_NO_ANDROID_EVIDENCE`
...
This is an environment/toolchain validation blocker, not evidence that the R15
runtime logic passed or failed on Android.
...
Because no Android evidence was collected, the next executable work is still an
R15A retry after environment/device readiness, not R16.
