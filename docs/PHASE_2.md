...
- [x] Не делать определение вещества
- [x] Не делать финальное экспертное заключение
- [x] Не делать судебно значимый отчет
- [x] Не делать полноценную калибровочную кривую концентрации
- [x] Не делать LOD/LOQ как валидированную лабораторную функцию
- [x] Не делать deconvolution overlapping peaks как обязательный блок
- [x] Не делать cloud sync, коммерческие лимиты/тарифы
- [x] Не делать ML-поиск пиков
- [x] Не делать автоматическое "положительно/отрицательно"

---

## 2.37 — Definition of Done для Фазы 2

- [x] Приложение принимает ExtractedSignal из Фазы 1
- [x] Приложение показывает интерактивный график
- [x] Приложение показывает raw/smoothed/baseline/corrected layers
- [x] Приложение считает baseline минимум manual linear и ALS
- [x] SNIP реализован как alternative/experimental метод
- [x] Приложение оценивает noise region
- [x] Приложение считает S/N с указанием метода
- [x] Приложение находит peak candidates
- [x] Приложение определяет boundaries
- [x] Приложение считает RT, height, area, width, prominence, S/N
- [x] Приложение показывает таблицу пиков
- [x] Приложение позволяет вручную двигать границы пика
- [x] Приложение позволяет вручную добавить/отклонить пик
- [x] После ручной коррекции метрики пересчитываются
- [x] Все параметры алгоритма сохраняются
- [x] Все ручные правки сохраняются
- [x] Результаты сохраняются в Room
- [x] Есть экспорт CSV/JSON
- [x] Есть unit tests расчетного ядра
- [x] Есть synthetic validation tests
- [x] Один и тот же signal + params + manual edits дает тот же результат
