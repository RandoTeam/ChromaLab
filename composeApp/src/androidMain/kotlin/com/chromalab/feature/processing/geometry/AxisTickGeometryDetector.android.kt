...
actual class AxisTickGeometryDetector actual constructor() {
    actual fun detect(
        ...
        return try {
            ...
            val xTicks = detectXTicks(gray, region.width, region.height, region, threshold, xAxisRun.row)
            val yTicks = detectYTicks(gray, region.width, region.height, region, threshold, yAxisRun.x)
