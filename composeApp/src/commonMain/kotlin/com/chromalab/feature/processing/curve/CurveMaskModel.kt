...
data class CurveTraceArtifactAudit(
    ...
    val cleanupHypothesisMaskPath: String? = null,
    val baselineRow: Int? = null,
    val artifactPixelCount: Int = 0,
    val artifactPixelRatio: Float = 0f,
    val cleanupHypothesisPixelCount: Int = 0,
    val cleanupHypothesisRetainedRatio: Float = 0f,
    val cleanupHypothesisColumnCoverage: Float = 0f,
    val thresholdRelaxationAllowed: Boolean = false,
    ...
    val cleanupHypothesisWarnings: List<String> = emptyList(),
